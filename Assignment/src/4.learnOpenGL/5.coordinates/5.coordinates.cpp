...
int main(int argc, char* argv[]) {
    ...
    vertexPathStream << logl_root
        << "/src/4.learnOpenGL/5.coordinates/vertex.vs";
    fragmentPathStream << logl_root
        << "/src/4.learnOpenGL/5.coordinates/fragment.fs";
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            model = glm::rotate(
                model,
                glm::radians(20.0f * (float)sin((i+1)*glfwGetTime())),
